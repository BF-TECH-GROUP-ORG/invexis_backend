// migrations/20251126_create_indexes.js
/**
...
exports.up = function (knex) {
  return knex.raw(`
    ...
    CREATE INDEX IF NOT EXISTS idx_payments_seller_id_status 
      ON payments(seller_id, status) 
      WHERE status IN ('pending','processing','succeeded');

    CREATE INDEX IF NOT EXISTS idx_payments_company_id_status 
    ...
    CREATE INDEX IF NOT EXISTS idx_payments_gateway_status_created 
      ON payments(gateway, status, created_at DESC);
    ...
    CREATE INDEX IF NOT EXISTS idx_transactions_seller_type_status 
      ON transactions(seller_id, type, status);

    CREATE INDEX IF NOT EXISTS idx_transactions_company_type_status 
      ON transactions(company_id, type, status) 
      WHERE company_id IS NOT NULL;
    ...
    CREATE INDEX IF NOT EXISTS idx_invoices_seller_status 
      ON invoices(seller_id, status);
